/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: de63e5bfcdf83ec79487411b34ae7615)
// Runtime types generated with workerd@1.20260305.0 2025-05-05 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./mockMain");
	}
	interface Env {
		MOCK_KV: KVNamespace;
		MOCK_DB: D1Database;
		IS_PROD: "no";
		MASTER_ROOT_KEY_V1: "testsecret5343sd";
		MASTER_ROOT_KEY_V2: "testsecret5343sd";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IS_PROD" | "MASTER_ROOT_KEY_V1" | "MASTER_ROOT_KEY_V2">> {}
}
